...
import { Calendar, Filter, Scale, AlertTriangle, Activity, Sprout, ArrowRight } from 'lucide-react';
    ...
    <div className="pb-24 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-earth-900 flex items-center gap-2">
            <Activity className="text-earth-600"/> Stats
        </h1>
      </div>
      ...
      <div className="bg-white p-4 rounded-xl border border-earth-200 shadow-sm space-y-4">
          ...
          <div className="flex gap-2">
             ...
             {/* Date Picker Toggle or Inputs could go here for Custom */}
          </div>
                     ...
                     {healthStats.contaminatedBatches.length === 0 ? (
                         ...
                         <div className="divide-y divide-earth-100">
                             {healthStats.contaminatedBatches.map(b => {
                                 // Look up the status config to get the color
                                 const statusConfig = userConfigs.statuses.find(s => s.name === b.outcome);
              ...
              <>
                ...
                <div className="space-y-4">
                    {Object.entries(pipelineStats.byStage).map(([stage, rawBatchList]) => {
                         ...
                         const opConfig = userConfigs.operations.find(op => op.name === stage);
