...
export const DEFAULT_STATUS_LIST: StatusConfig[] = [
  { id: '1', name: '无污染', colorHex: '#22c55e' },
  { id: '2', name: '轻微污染', colorHex: '#eab308' },
  { id: '3', name: '污染废弃', colorHex: '#ef4444' }
];

export const DEFAULT_RECIPE_TYPES = ['Agar', 'Liquid Culture', 'Spawn'];
...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    storage_tab: 'Storage',
    date: 'Date',
    confirm_q: 'Are you sure you want to proceed?',
    placeholder_add_name: 'Enter name...',
    species_tab: 'Species',
    operations_tab: 'Operations',
    statuses_tab: 'Statuses',
    data_tab: 'Data',
    storage_hint: 'This will permanently delete photos before the selected date from cloud storage.'
  }
};
